...
const translations = {
  en: {
    ...
    'live.waiting': 'Waiting for hub…',
    'live.turn': 'turn',
    'live.watcher': 'Watcher',
    'live.pending': 'Pending wake',
    'live.lastWake': 'Last wake id',
    'live.watcherOn': '{n} connected',
    'live.watcherOff': 'not connected',
    'live.none': 'none',
    'live.epoch': 'epoch',
    'live.branch': 'branch',
    'live.action': 'action',
  ...
  zh: {
    ...
    'outcomes.label': '结果统计',
    'live.title': '实时状态',
    'live.autoRefresh': '自动刷新',
    'live.waiting': '等待 Hub…',
    'live.turn': '当前回合',
    'live.watcher': 'Watcher',
    'live.pending': '待处理唤醒',
    'live.lastWake': '最新唤醒 id',
    'live.watcherOn': '已连接 {n} 个',
    'live.watcherOff': '未连接',
    'live.none': '无',
    'live.epoch': '轮次',
    'live.branch': '分支',
