const translations = {
  en: {
    ...
    'setup.copy': 'Copy',
    'setup.copied': 'Copied!',
    'setup.maxEpochsError': 'Max epochs must be a positive integer',
    'setup.profileJson': 'Profile JSON (POST /setup)',
    ...
    'feat3.desc': 'Agents re-anchor with <code>/snapshot</code> — state, profile, history, lessons, and health live on the hub.',
    ...
    'arch.mcp.1': '<code>coord_start</code> · <code>coord_doctor</code>',
    'arch.mcp.2': '<code>coord_snapshot</code> · <code>coord_lessons</code>',
    'arch.mcp.3': '<code>coord_signal</code> · <code>coord_signal_outcome</code>',
    'arch.hub.1': '<code>/wait/A</code> · <code>/wait/B</code>',
    'arch.hub.2': '<code>/snapshot</code> · <code>/lessons</code> · <code>/health</code>',
    'arch.hub.3': '<code>/signal</code> · <code>/setup</code> · <code>/reset</code>',
  ...
  zh: {
    ...
    'setup.copy': '复制',
    'setup.copied': '已复制！',
    'setup.maxEpochsError': '最大轮次必须是正整数',
    'setup.profileJson': 'Profile JSON（POST /setup）',
    ...
    'feat3.title': '简短提示词',
    'feat3.desc': 'Agent 通过 <code>/snapshot</code> 重新锚定上下文 — state、profile、history、lessons 和 health 都存在 Hub。',
    'feat4.title': '/loop 唤醒',
